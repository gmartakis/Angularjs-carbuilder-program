				...
				for(var i = 0; i < jsonstr.config.model.grades.grade.vehicles.length; i++) 
					{
						...
						vehicleBodyWork = jsonstr.config.model.grades.grade.vehicles[i].vehicle.doors['#text'];
...
function ApplyFilters(event, jsonstr, gradeName, arrayFuelType, arrayengine, arraytransmission, arrayprice, arrayname, arraybody, storeuniqueFuel) {
	...
	if(counter == 0){
		...
		$('#columns > div.stepClose > a:nth-child(2)').on('click', function()
				...
				if($('#FourthGrade').is(':checked'))
				 ...
				 {	
					...
					infoStdHelp();
				 	...
				 	displayEngineAndMotersGradeH(pushVehicleEngineH, pushtheVehicleNameH, pushVehicleFuelTypeH, pushVehiclePriceH, pushVehicleTransH, pushVehicleBodyH);
				 ...
				 {	
					...
					infoStdHelp();
				 	...
				 	displayEngineAndMotersGradeI(pushVehicleEngineI, pushtheVehicleNameI, pushVehicleFuelTypeI, pushVehiclePriceI, pushVehicleTransI, pushVehicleBodyI);
				 ...
				 {	
					...
					infoStdHelp();
				 	...
				 	displayEngineAndMotersGradeJ(pushVehicleEngineJ, pushtheVehicleNameJ, pushVehicleFuelTypeJ, pushVehiclePriceJ, pushVehicleTransJ, pushVehicleBodyJ);
			...
			$('#columns > div.stepOneClose > a:nth-child(2)').on('click', function()
			{
			...
			$('#columns > div.stepTwoClose > a:nth-child(2)').on('click', function()
					{
			...
			$('#columns > div.stepThirdClose > a:nth-child(3)').on('click', function()
			 {
	...
	function displayEngineAndMotersGradeA(engineArrayHolder, vehicleNameHolderA, vehicleHolderFuelTypeA, vehiclePriceHolderA, vehicleTransHolderA, vehicleBodyHolderA)
	{
		...
		var stringInfo = '<span class="std-help" data-tooltip="false" data-hasqtip="true" aria-describedby="qtip-0">'+
			...
			if($('#displayMoters').length > 0)
				{
					...
					$('#columns > div.stepOneClose > a:nth-child(3)').on('click', function()
					{
				...
				$('#columns > div.stepTwoClose > a:nth-child(3)').on('click', function()
				{
			...
			$('#columns > div.stepNextThirdClose > a:nth-child(2)').on('click', function()
				{
					//$('#columns > div.stepNextThirdClose').find('#mainContentconf').find('#tabs').find('#tabs-1').empty();
			  ...
			  $('#columns > div.stepNextThirdClose > a:nth-child(3)').on('click', function()
			 {
			 ...
			 $('#columns > div.stepThirdClose > a:nth-child(2)').on('click', function()
			 {
	...
	function displayAccessoriesSummaries(ArrayHolderValue, stadarPriceVehicle, ArrayHolderImage, ArrayHolderName, ArrayHolderSKU, ArrayHolderDesc)
	{
		...
		if(ArrayHolderName.length > 0)
		{
			...
			{
				HTML2.push();
				var current = parseFloat(ArrayHolderValue[i]*1.23);
				var theCurrent = formatNumber(current);
		...
		var theTOTAL = formatNumber(TOTAL);	
			...
			if(ArrayHolderValue.length > 0)
			{
				...
				HTML2.push('<tr><td><h2 style="font-size:15px;">Τιμή τών αξεσουάρ: </td><td style="font-size:15px; color:#c71444; font-weight:bold; font-family:Conv_Nissan Brand Regular, Sans-Serif;">&euro;'+TotaldataSum+'</h2></td></tr>');	
				HTML2.push('<tr><td><h2 style="font-size:15px;">Τελική τιμή: </td><td style="font-size:15px; color:#c71444; font-weight:bold; font-family:Conv_Nissan Brand Regular, Sans-Serif;">&euro;'+Totalsum+'</h2></td></tr>');	
		...
		var theTOTAL = formatNumber(TOTAL);	
			...
			if(ArrayHolderValue.length > 0)
			{
				...
				HTML2.push('<tr><td><h2 style="font-size:15px;">Τιμή τών αξεσουάρ: </td><td style="font-size:15px; color:#c71444; font-weight:bold; font-family:Conv_Nissan Brand Regular, Sans-Serif;">&euro;'+theTotaldataSum+stringInfo+'</h2></td></tr>');	
	...
	function drawTableAccessoryA(accessoryImageHolder, stadarPriceVehicle, accessorySKUHolder, accessoryNameHolder, accessoryDescHolder, accessoryPriceHolder)
	{
		...
		{
			var current = parseFloat(accessoryPriceHolder[i]*1.23);
			var theCurrent = formatNumber(current);
...
function displayEngineAndMotersGradeH(engineArrayHolder, vehicleNameHolderH, vehicleHolderFuelTypeH, vehiclePriceHolderH, vehicleTransHolderH, vehicleBodyHolderH)
	{
		var HTML = [];
		var result;
		var ArrayHolderVehicle = new Array(8);
		...
		var HTML1 = [];
			...
			for(var i = 0; i < engineArrayHolder.length; i++)
			{
				...
				+ '<td style="width:70%; padding-left:10px; font-weight:normal !important; font-style:italics;" valign="middle"><ul><li>'+vehicleHolderFuelTypeH[i]+ '</li><li>'+vehicleBodyHolderH[i]+ '</li><li>' +vehicleTransHolderH[i]+ '</li></ul></td>'
				+ '<td style="width:20%; font-weight:normal !important; font-style:italic;" valign="middle" align="right">&euro;'+theCurrent+stringInfo+'</td>'+
				'</tr></table></div>');
			}
...
function displayEngineAndMotersGradeI(engineArrayHolder, vehicleNameHolderG, vehicleHolderFuelTypeG, vehiclePriceHolderG, vehicleTransHolderG, vehicleBodyHolderG)
	{
		var HTML = [];
		var result;
		var ArrayHolderVehicle = new Array(8);
...
function displayEngineAndMotersGradeJ(engineArrayHolder, vehicleNameHolderG, vehicleHolderFuelTypeG, vehiclePriceHolderG, vehicleTransHolderG, vehicleBodyHolderG)
	{
		var HTML = [];
		var result;
		var ArrayHolderVehicle = new Array(8);
