...
function ApplyFilters(event, jsonstr, gradeName, arrayFuelType, arrayengine, arraytransmission, arrayprice, arrayname, arraybody, storeuniqueFuel) {
	...
	if(counter == 0){
		$('#mainContentconf > div:nth-child(6) > a > span').off('click');
		 ...
		 //var LiGradeDiv = $('#columns > div.stepClose').find('#mainContentscroll > ul > li > div > ul > li > div');
		 
		 var counterDiv = 0;
		 
		/* if($('#columns > div.stepClose').find('#mainContentscroll > ul > li > div > ul > li > div').length == 7){
		 		$('#columns > div.stepClose').find('#mainContentscroll').css('width', '1700px');
		 	}
		 */	
		
		 
		/*if($('#columns > div.stepClose').find('#mainContentscroll > ul > li > div > ul > li > div').length > 6)
		 {
		 	$('#columns > div.stepClose').find('#mainContentscroll').css('width', '1700px');
		 }
		*/
												...
												if(jsonstr.config.model.grades[0].grade.vehicles[i].vehicle.colors instanceof Array)
													...
													if(jsonstr.config.model.grades[0].grade.vehicles[i].vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[0].grade.vehicles[i].vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[0].grade.vehicles[i].vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[0].grade.vehicles[i].vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[0].grade.vehicles.vehicle.colors instanceof Array)
													...
													if(jsonstr.config.model.grades[0].grade.vehicles.vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[0].grade.vehicles.vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[0].grade.vehicles.vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[0].grade.vehicles.vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[1].grade.vehicles[i].vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[1].grade.vehicles[i].vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[1].grade.vehicles[i].vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[1].grade.vehicles[i].vehicle.accessories.accessory['@attributes'].accessoryImage;
											...
											if(jsonstr.config.model.grades[1].grade.vehicles.vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[1].grade.vehicles.vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[1].grade.vehicles.vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[1].grade.vehicles.vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[2].grade.vehicles[i].vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[2].grade.vehicles[i].vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[2].grade.vehicles[i].vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[2].grade.vehicles[i].vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[2].grade.vehicles.vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[2].grade.vehicles.vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[2].grade.vehicles.vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[2].grade.vehicles.vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[3].grade.vehicles[i].vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[3].grade.vehicles[i].vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[3].grade.vehicles[i].vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[3].grade.vehicles[i].vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[3].grade.vehicles.vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[3].grade.vehicles.vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[3].grade.vehicles.vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[3].grade.vehicles.vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[4].grade.vehicles[i].vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[4].grade.vehicles[i].vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[4].grade.vehicles[i].vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[4].grade.vehicles[i].vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[4].grade.vehicles.vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[4].grade.vehicles.vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[4].grade.vehicles.vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[4].grade.vehicles.vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[5].grade.vehicles[i].vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[5].grade.vehicles[i].vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[5].grade.vehicles[i].vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[5].grade.vehicles[i].vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[5].grade.vehicles.vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[5].grade.vehicles.vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[5].grade.vehicles.vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[5].grade.vehicles.vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[6].grade.vehicles[i].vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[6].grade.vehicles[i].vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[6].grade.vehicles[i].vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[6].grade.vehicles[i].vehicle.accessories.accessory['@attributes'].accessoryImage;
												...
												if(jsonstr.config.model.grades[6].grade.vehicles.vehicle.accessories instanceof Array)
													{
														for(var j = 0; j < jsonstr.config.model.grades[6].grade.vehicles.vehicle.accessories.length; j++)
														{
																...
																accessoryImage = jsonstr.config.model.grades[6].grade.vehicles.vehicle.accessories[j].accessory['@attributes'].accessoryImage; 
													...
													{
																accessoryImage = jsonstr.config.model.grades[6].grade.vehicles.vehicle.accessories.accessory['@attributes'].accessoryImage;
 ...
 */
	...
	function displaysGradeBname(gradeNameArray, minRangeSecondGradePrice)
	{
		uniqueGradesB = GetUnique(gradeNameArray);
		$('#columns > div.stepOneClose').show("slide", { direction: "right" }, 1000)
											.find('#dividetwo > div:nth-child(1) > h1').
				 							html("ΕΚΔΟΣΗ "+uniqueGradesB);
		
		displayGradeImageAndPriceB(imageHolderGradeB, minRangeSecondGradePrice);
		//$('#columns > div.stepOneClose').find('#dividetwo > div:nth-child(1) > h4').filter('titlerangeprice').html("Τιμή από: "+minimumPrice);
		
	}
	
	function displayGradeImageAndPriceB(imagerGradeB, minRangeSecondGradePrice)
	{
		var minPriceB = formatNumber(minRangeSecondGradePrice);
		stringInfo = '<span class="std-help" data-tooltip="false" data-hasqtip="true" aria-describedby="qtip-0">'+
                        '<img src="http://skin.nissan.gr/default/images/common/info-icon-medium.png" alt="Help: ">'+
                        '<span class="after" style="display: none;">Σύμφωνα με την πολιτική της εταιρείας περί συνεχούς βελτίωσης των προϊόντων της, η NISSAN διατηρεί το δικαίωμα να αλλάξει τις προδιαγραφές και τις τιμές, για τα οχήματα που περιγράφονται και παρουσιάζονται στην ιστοσελίδα μας, οποιαδήποτε στιγμή.</span>'
                    +'</span>';
		//var minPriceB = formatNumber(minRangeSecondGradePrice);
		$('#dividetwo > div:nth-child(1) > h4').filter('.titlerangeprice').html("Τιμή: &euro;"+minPriceB + stringInfo);
		
		infoStdHelp();
		
		$('#dividetwo > div:nth-child(2) > span').filter('.imageClass').html(imagerGradeB);
	...
	function displaysGradeCname(gradeNameArray, minRangeThirdGradePrice)
	{
		uniqueGradesC = GetUnique(gradeNameArray);
		$('#columns > div.stepOneClose').show("slide", { direction: "right" }, 1000)
											.find('#dividetwo > div:nth-child(1) > h1').
				 							html("ΕΚΔΟΣΗ "+uniqueGradesC);
		
		displayGradeImageAndPriceC(imageHolderGradeC, minRangeThirdGradePrice);
		//$('#columns > div.stepOneClose').find('#dividetwo > div:nth-child(1) > h4').filter('titlerangeprice').html("Τιμή από: "+minimumPrice);
		
	}
	//Grade D
	function displaysGradeDname(gradeNameArray, minRangeFourthGradePrice)
	{
		uniqueGradesD = GetUnique(gradeNameArray);
		$('#columns > div.stepOneClose').show("slide", { direction: "right" }, 1000)
											.find('#dividetwo > div:nth-child(1) > h1').
				 							html("ΕΚΔΟΣΗ "+uniqueGradesD);
		
		displayGradeImageAndPriceD(imageHolderGradeD, minRangeFourthGradePrice);
		//$('#columns > div.stepOneClose').find('#dividetwo > div:nth-child(1) > h4').filter('titlerangeprice').html("Τιμή από: "+minimumPrice);
		
	}
	
	function displayGradeImageAndPriceD(imagerGradeD, minRangeFourthGradePrice)
	{
		var minPriceD = formatNumber(minRangeFourthGradePrice);
		stringInfo = '<span class="std-help" data-tooltip="false" data-hasqtip="true" aria-describedby="qtip-0">'+
                        '<img src="http://skin.nissan.gr/default/images/common/info-icon-medium.png" alt="Help: ">'+
                        '<span class="after" style="display: block;">Σύμφωνα με την πολιτική της εταιρείας περί συνεχούς βελτίωσης των προϊόντων της, η NISSAN διατηρεί το δικαίωμα να αλλάξει τις προδιαγραφές και τις τιμές, για τα οχήματα που περιγράφονται και παρουσιάζονται στην ιστοσελίδα μας, οποιαδήποτε στιγμή.</span>'
                    +'</span>';
		
		//var minPriceC = formatNumber(minRangeThirdGradePrice);
		$('#dividetwo > div:nth-child(1) > h4').filter('.titlerangeprice').html("Τιμή: &euro;"+minPriceD + stringInfo);
		
		infoStdHelp();
		
		$('#dividetwo > div:nth-child(2) > span').filter('.imageClass').html(imagerGradeD);
		
		
	}
	
	//Grade E
	function displaysGradeEname(gradeNameArray, minRangeFifthGradePrice)
	{
		uniqueGradesE = GetUnique(gradeNameArray);
		$('#columns > div.stepOneClose').show("slide", { direction: "right" }, 1000)
											.find('#dividetwo > div:nth-child(1) > h1').
				 							html("ΕΚΔΟΣΗ "+uniqueGradesE);
		
		displayGradeImageAndPriceE(imageHolderGradeE, minRangeFifthGradePrice);
		//$('#columns > div.stepOneClose').find('#dividetwo > div:nth-child(1) > h4').filter('titlerangeprice').html("Τιμή από: "+minimumPrice);
		
	}
	
	function displayGradeImageAndPriceE(imagerGradeE, minRangeFifthGradePrice)
	{
		var minPriceE = formatNumber(minRangeFifthGradePrice);
		stringInfo = '<span class="std-help" data-tooltip="false" data-hasqtip="true" aria-describedby="qtip-0">'+
                        '<img src="http://skin.nissan.gr/default/images/common/info-icon-medium.png" alt="Help: ">'+
                        '<span class="after" style="display: block;">Σύμφωνα με την πολιτική της εταιρείας περί συνεχούς βελτίωσης των προϊόντων της, η NISSAN διατηρεί το δικαίωμα να αλλάξει τις προδιαγραφές και τις τιμές, για τα οχήματα που περιγράφονται και παρουσιάζονται στην ιστοσελίδα μας, οποιαδήποτε στιγμή.</span>'
                    +'</span>';
		...
		//var minPriceC = formatNumber(minRangeThirdGradePrice);
		$('#dividetwo > div:nth-child(1) > h4').filter('.titlerangeprice').html("Τιμή: &euro;"+minPriceE + stringInfo);
		
		infoStdHelp();
		
		$('#dividetwo > div:nth-child(2) > span').filter('.imageClass').html(imagerGradeE);
		
		
	}
	
	//Grade F
	function displaysGradeFname(gradeNameArray, minRangeSixthGradePrice)
	{
		uniqueGradesF = GetUnique(gradeNameArray);
		$('#columns > div.stepOneClose').show("slide", { direction: "right" }, 1000)
											.find('#dividetwo > div:nth-child(1) > h1').
				 							html("ΕΚΔΟΣΗ "+uniqueGradesF);
		
		displayGradeImageAndPriceF(imageHolderGradeF, minRangeSixthGradePrice);
		//$('#columns > div.stepOneClose').find('#dividetwo > div:nth-child(1) > h4').filter('titlerangeprice').html("Τιμή από: "+minimumPrice);
		
	}
	
	function displayGradeImageAndPriceF(imagerGradeF, minRangeSixthGradePrice)
	{
		var minPriceF = formatNumber(minRangeSixthGradePrice);
		stringInfo = '<span class="std-help" data-tooltip="false" data-hasqtip="true" aria-describedby="qtip-0">'+
                        '<img src="http://skin.nissan.gr/default/images/common/info-icon-medium.png" alt="Help: ">'+
                        '<span class="after" style="display: block;">Σύμφωνα με την πολιτική της εταιρείας περί συνεχούς βελτίωσης των προϊόντων της, η NISSAN διατηρεί το δικαίωμα να αλλάξει τις προδιαγραφές και τις τιμές, για τα οχήματα που περιγράφονται και παρουσιάζονται στην ιστοσελίδα μας, οποιαδήποτε στιγμή.</span>'
                    +'</span>';
		...
		//var minPriceC = formatNumber(minRangeThirdGradePrice);
		$('#dividetwo > div:nth-child(1) > h4').filter('.titlerangeprice').html("Τιμή: &euro;"+minPriceF + stringInfo);
		
		infoStdHelp();
		
		$('#dividetwo > div:nth-child(2) > span').filter('.imageClass').html(imagerGradeF);
		
		
	}
	
	//Grade G
	function displaysGradeGname(gradeNameArray, minRangeSeventhGradePrice)
	{
		uniqueGradesG = GetUnique(gradeNameArray);
		$('#columns > div.stepOneClose').show("slide", { direction: "right" }, 1000)
											.find('#dividetwo > div:nth-child(1) > h1').
				 							html("ΕΚΔΟΣΗ "+uniqueGradesG);
		
		displayGradeImageAndPriceG(imageHolderGradeG, minRangeSeventhGradePrice);
		//$('#columns > div.stepOneClose').find('#dividetwo > div:nth-child(1) > h4').filter('titlerangeprice').html("Τιμή από: "+minimumPrice);
		
	}
	
	function displayGradeImageAndPriceG(imagerGradeG, minRangeSeventhGradePrice)
	{
		var minPriceG = formatNumber(minRangeSixthGradePrice);
		stringInfo = '<span class="std-help" data-tooltip="false" data-hasqtip="true" aria-describedby="qtip-0">'+
                        '<img src="http://skin.nissan.gr/default/images/common/info-icon-medium.png" alt="Help: ">'+
                        '<span class="after" style="display: block;">Σύμφωνα με την πολιτική της εταιρείας περί συνεχούς βελτίωσης των προϊόντων της, η NISSAN διατηρεί το δικαίωμα να αλλάξει τις προδιαγραφές και τις τιμές, για τα οχήματα που περιγράφονται και παρουσιάζονται στην ιστοσελίδα μας, οποιαδήποτε στιγμή.</span>'
                    +'</span>';
		...
		//var minPriceC = formatNumber(minRangeThirdGradePrice);
		$('#dividetwo > div:nth-child(1) > h4').filter('.titlerangeprice').html("Τιμή: &euro;"+minPriceG + stringInfo);
		
		infoStdHelp();
		
		$('#dividetwo > div:nth-child(2) > span').filter('.imageClass').html(imagerGradeG);
		
		
	}
	
	function displayGradeImageAndPriceC(imagerGradeC, minRangeThirdGradePrice)
	{
		var minPriceC = formatNumber(minRangeThirdGradePrice);
		stringInfo = '<span class="std-help" data-tooltip="false" data-hasqtip="true" aria-describedby="qtip-0">'+
                        '<img src="http://skin.nissan.gr/default/images/common/info-icon-medium.png" alt="Help: ">'+
		...
		//var minPriceC = formatNumber(minRangeThirdGradePrice);
		$('#dividetwo > div:nth-child(1) > h4').filter('.titlerangeprice').html("Τιμή: &euro;"+minPriceC + stringInfo);
		
		infoStdHelp();
		
		$('#dividetwo > div:nth-child(2) > span').filter('.imageClass').html(imagerGradeC);
